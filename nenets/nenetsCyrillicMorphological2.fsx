...
let orthography = 
    let basicsLettersReplacement =
        [
            ...
            ("h", "н" + combiningBreve); //Consonant Velarised Small
            ...
            ("q", "т" + combiningBreve); //Consonant Velarised Small
            ...
            ("H", "Н" + combiningBreve); //Consonant Velarised Capital
            ...
            ("Q", "Т" + combiningBreve); //Consonant Velarised Capital
            ...
            ("Ŋ", "Ӈ"); //Consonant Velarised Capital
            ...
            ("ʹǣ", "*"); //Vowel Palatalised Small - Does not exist
...
let outputFileName = "./nenets/text/TundraNenetsCyrillicMorphological2.txt"
inputFileName
