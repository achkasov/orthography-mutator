...
let orthography = 
    let basicsLettersReplacement =
        [
            ...
            ("h", combiningTilde); //Consonant Velarised Small
            ...
            ("q", combiningBreve); //Consonant Velarised Small
            ...
            ("H", combiningTilde); //Consonant Velarised Capital
            ...
            ("Q", combiningBreve); //Consonant Velarised Capital
...
let outputFileName = "./nenets/text/TundraNenetsCyrillicMorphological3.txt"
inputFileName
