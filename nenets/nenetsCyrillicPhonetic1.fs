...
let orthography = 
    let basicsLettersReplacement =
        [
            ...
            ("H", "Қ"); //Consonant Velarised Capital
            ...
            ("Q", "Қ"); //Consonant Velarised Capital
...
let outputFileName = "./nenets/text/TundraNenetsCyrillicPhonetic1.txt"
inputFileName
