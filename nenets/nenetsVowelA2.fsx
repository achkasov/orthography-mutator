...
let outputFileName = "./nenets/text/TundraNenetsVowelA2.txt"
...
let orthography = 
  ...
  let engInitialReplacement =
    [ ("#Ŋ","#Nn");
      ("#ŋ","#nn");
    ]

  let engCapsInitialRemoval =
    let capitalNg = "Ŋ"
  ...
  @ qFinalReplacement
  @ engFinalReplacement
  // @ engInitialReplacement
  @ engCapsInitialRemoval
  @ engLowInitialRemoval
  @ engMedialdReplacement
  @ qMedialdReplacement
  @ weakEReplacement
